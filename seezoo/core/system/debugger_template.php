...
#<?php echo $id;?> h2{margin:15px 0;border-bottom:solid 1px #187FC4;padding-bottom:10px;}
...
<?php foreach ( array_reverse(SeezooFactory::getInstancesForDebug()) as $key => $process ):?>
<tr>
...
<table>
<tbody>
<tr><th>module type</th><th>module names</th></tr>
<tr>
<td width="30%">Libraries</td>
<td width="70%" style="text-align:left;padding:10px 20px;">
&nbsp;<?php foreach ( SeezooFactory::getLoadedLibraries() as $libs ):?>
<?php echo prep_str($this->_formatLibName($libs));?>&emsp;
<?php endforeach;?>
</td>
</tr>
<tr>
<td width="30%">Models</td>
<td width="70%" style="text-align:left;padding:10px 20px;">
&nbsp;<?php foreach ( SeezooFactory::getLoadedModels() as $libs ):?>
<?php echo prep_str($this->_formatLibName($libs));?>&emsp;
<?php endforeach;?>
</td>
</tr>
<tr>
<td width="30%">Helpers</td>
<td width="70%" style="text-align:left;padding:10px 20px;">
&nbsp;<?php foreach ( SeezooFactory::getLoadedHelpers() as $libs ):?>
<?php echo prep_str($this->_formatLibName($libs));?>&emsp;
<?php endforeach;?>
</td>
</tr>
...
<table>
<tbody>
<?php $dbs = SeezooFactory::getConnectedDBs();?>
<?php if ( count($dbs) > 0 ):?>
